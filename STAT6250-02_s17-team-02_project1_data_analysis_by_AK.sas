...
title3
'Top Ten Carrier Worst Affected by Weather Condition'
;
...
/*
*******************************************************************************;
Methodology: Use PROC PRINT to print just the first ten observations from the 
temporary dataset created in the corresponding data-prep file.

Limitations: This dataset has only data for year 2013.  

Possible Follow-up Steps: Missing values are already excluded in data-prep file. 
We can increase the number of years by loading all data in GitHub repository but maintain same file structure.
*******************************************************************************;
*/
...
title3
'Top Ten Airport Worst Affected by Weather Condition'
;

footnote1
'Based on the above output, Rock Springs Airport, WY: Rock Springs Sweetwater County (RKS) has the longest delay on average which is 86 minutes.'
;

footnote2
'Oxnard/Ventura Airport, CA: Oxnard has the second longest delay time which is 77 minutes.'
;

footnote3
'It would be interesting to look at the location data and their weather data and delay due to weather to question which airport is better but we do not have the access to those data.' 
;
...
data-prep file. We can increase the number of years by loading all data in GitHub repository but maintain same file structure.
*******************************************************************************;
*/
...
title2
'Rationale: To identify the frequency and percentage of diverted flights per carrier'
;

footnote1 
'The table above shows the frequency and the percentage of diverted flights for each Carrier based on the total number of diverted flights'
;
...
/* 
*******************************************************************************;
Methodology: Using PROC FREQ command percentage of diverted flights will be 
shown from sorted dataset
